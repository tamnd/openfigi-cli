...
// HTTP behaviour is covered in openfigi_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "openfigi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("openfigi", "about")
	if err != nil || got.String() != "openfigi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want openfigi://page/about", got.String(), err)
	}
}
