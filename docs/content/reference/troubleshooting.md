...
Most of these come down to network reality or how openfigi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openfigi rate-limits like any public site. openfigi already paces
...
Where a surface is gated, openfigi reads a cookie or token you supply
...
`openfigi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openfigi actually did
